function makeBlock(e, callback) {
    if (callback === void 0) { callback = function (c) { return c; }; }
    var colors = {
        'default': {
            'title': {
    ...
    Array.prototype.forEach.call(e.getElementsByClassName('block'), function (e, i, a) {
